...
import blog6 from '../../images/blog/author.jpg'
...
const BlogDetails = () => {
    ...
    return(
        <section className="hx-blog-single-section hx-section-padding">
        <div className="container">
            <div className="row">
                <div className="col col-lg-8 col-md-12 col-sm-12 col-12">
                    <div className="hx-blog-content clearfix">
                        <div className="post">
                        ...
                        <div className="tag-share clearfix">
                            <div className="tag">
                                <ul>
                                    ...
                                    <li><Link to="/blog-single">New Brand</Link></li>
                                    <li><Link to="/blog-single">Car</Link></li>
                                </ul>
                            </div>
                            <div className="share">
                                <ul>
                                    <li><Link to="/blog-single"><i className="ti-facebook"></i></Link></li>
                                    <li><Link to="/blog-single"><i className="ti-twitter-alt"></i></Link></li>
                                    <li><Link to="/blog-single"><i className="ti-linkedin"></i></Link></li>
                                    <li><Link to="/blog-single"><i className="ti-instagram"></i></Link></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="author-box">
                            <div className="author-avatar">
                                <Link to="/blog-single" target="_blank"><img src={blog2} alt=""/></Link>
                            </div>
                            <div className="author-content">
                                <Link to="/blog-single" className="author-name">Henry Joyes</Link>
                            ...
                            <div className="comments-section">
                                ...
                                <ol className="comments">
                                            ...
                                            <div className="comment-main-area">
                                                <div className="comment-wrapper">
                                                    <div className="comments-meta">
                                                        <h4>John Abraham <span className="comments-date">Octobor 28,2019 At 9.00am</span></h4>
                                                    </div>
                                                    <div className="comment-area">
                                                        ...
                                                        <div className="comments-reply">
                                                            <Link className="comment-reply-link" to="/blog-single"><span>Reply</span></Link>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <li className="comment">
                                                <div>
                                                    ...
                                                    <div className="comment-main-area">
                                                        <div className="comment-wrapper">
                                                            <div className="comments-meta">
                                                                <h4>Lily Watson <span className="comments-date">Octobor 28,2019 At 9.00am</span></h4>
                                                            </div>
                                                            <div className="comment-area">
                                                                <p>I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, </p>
                                                                <div className="comments-reply">
                                    ...
                                    <li className="comment">
                                        <div>
                                            <div className="comment-theme">
                                                <div className="comment-image"><img src={blog2} alt=""/></div>
                                            </div>
                                            <div className="comment-main-area">
                                                <div className="comment-wrapper">
                                                    <div className="comments-meta">
